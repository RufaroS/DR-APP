...
def generate_medical_report(image_name, predicted_class, info):
...
# App Header
st.markdown('<p class="main-header">👁️ RetinaScan Pro</p>', unsafe_allow_html=True)
...
if page == "Clinical Screening":
    ...
    if not model_loaded:
        st.error("⚠️ Model failed to load. Please check your internet connection and refresh the page.")
    ...
    with col1:
        st.markdown("""
        <div class="medical-card">
            <h4>📊 Diabetes & DR Prevalence</h4>
            <p><strong>North Africa:</strong> 8.9% Diabetes | 22.5% DR</p>
            <p><strong>West Africa:</strong> 4.5% Diabetes | 18.3% DR</p>
            <p><strong>East Africa:</strong> 5.1% Diabetes | 20.1% DR</p>
            <p><strong>Southern Africa:</strong> 7.2% Diabetes | 25.4% DR</p>
            <p><strong>Central Africa:</strong> 3.8% Diabetes | 16.7% DR</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        st.markdown("""
        <div class="medical-card">
            <h4>📈 DR Risk Over Time</h4>
            <p><strong>0 years:</strong> 0% risk</p>
            <p><strong>5 years:</strong> 15% risk</p>
            <p><strong>10 years:</strong> 40% risk</p>
            <p><strong>15 years:</strong> 65% risk</p>
            <p><strong>20 years:</strong> 85% risk</p>
        </div>
        """, unsafe_allow_html=True)
